...
public class ArithmeticService {
    ...
    public boolean isTwoEvenNumbers(int ...numbers) {
    ...
    public double calculateArithmeticFunction(double argument) {
        ArithmeticValidator arithmeticValidator = new ArithmeticValidator();
    ...
    public SortedMap<Double, Double> calculateTrigonometricFunction(double firstPoint, double secondPoint, double functionStep){
        ArithmeticValidator arithmeticValidator = new ArithmeticValidator();
